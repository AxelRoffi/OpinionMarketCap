...
async function main() {
    console.log("🚀 Starting OpinionMarketCap V1 Deployment with Libraries on Base Sepolia...");
    ...
    // ===== STEP 2: DEPLOY OPINIONCORE WITH LIBRARIES =====
    console.log("\n📦 Step 2: Deploying OpinionCore with library linking...");
