        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/pools" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Funding Pools
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/blog" className="text-muted-foreground hover:text-foreground text-sm transition-colors inline-flex items-center gap-2">
