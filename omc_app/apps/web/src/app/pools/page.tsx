      ...
      <div className="min-h-screen bg-background pt-20">
        <div className="container mx-auto px-4 py-8">
          <div className="animate-pulse">
            <div className="h-8 bg-muted rounded mb-8 max-w-sm"></div>
  ...
  return (
    <>
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <h3 className="text-xl font-bold text-foreground mb-4">How Pools Work</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-muted-foreground">
            <div>
              <h4 className="font-semibold text-foreground mb-2">1. Create or Join a Pool</h4>
              <p>
            ...
            <div>
              <h4 className="font-semibold text-foreground mb-2">2. Fund the Pool</h4>
              <p>
                The goal is to collectively reach the opinion's <code className="bg-muted p-1 rounded">nextPrice</code> before the deadline.
            ...
            <div>
              <h4 className="font-semibold text-foreground mb-2">3. Share the Rewards</h4>
              <p>
        ...
        >
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-6 bg-muted border-border">
              <TabsTrigger 
                value="active" 
          ...
          <Select value={sortFilter} onValueChange={setSortFilter}>
            ...
            <SelectContent>
              ...
              {/* Refresh Button */}
              <Button variant="outline" size="icon" className="border-border bg-muted text-foreground hover:bg-accent" onClick={refetch}>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Pool</TableHead>
                  <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Progress</TableHead>
                  <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Amount</TableHead>
                  <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Contributors</TableHead>
                  <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Time Left</TableHead>
                  <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Status</TableHead>
                  <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Actions</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {sortedPools.length === 0 ? (
                  ...
                  sortedPools.map((pool, index) => (
                    <TableRow key={pool.id} className="border-b border-border/40 hover:bg-muted/20">
                        ...
                        <div>
                          ...
                          <h4 className="font-medium text-lg mt-2">
                            <button
                              ...
                              className="text-foreground hover:text-emerald-500 transition-colors cursor-pointer text-left"
                            >
                              {pool.name}
                            </button>
                          </h4>
                      ...
                      <TableCell className="py-4 px-6">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-foreground">{pool.contributorCount}</span>
                        </div>
                      </TableCell>
                      ...
                      <TableCell className="py-4 px-6">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-foreground">{pool.timeLeft}</span>
                        </div>
                      </TableCell>
              ...
              <Card className="bg-card/50 border-border backdrop-blur-sm">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Pool</TableHead>
                      <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Final Progress</TableHead>
                      <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Final Amount</TableHead>
                      <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Contributors</TableHead>
                      <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Completion Date</TableHead>
                      <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Result</TableHead>
                      <TableHead className="text-left py-4 px-6 text-foreground font-semibold">Actions</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
